...
- 📧 **Email me** at **sohampatil49690@gmail.com** if you’d like to view the code privately for evaluation purposes.  
...
1. Clone repo
```bash
git clone https://github.com/Soham-patil18/NammaKisan.git
```
2. Go to backend
```bash
cd backend
...
**soham patil**  
 ...
 <br>
 🔗 [Live Project](https://nammakisan-frontend1.onrender.com/)
<br>
